...
urlpatterns = [
     ...
     # path('fetch_guests', GetGuests.as_view(), name="fetch_guests"),
     path('flat_files_upload', FlatDataUpload.as_view(), name="flat_files_upload"),
     path('delete_flat_data', DeleteFlatData.as_view(), name='delete_flat_data'),
     path('qr_code', Qrdata.as_view(), name="qr_code"),
     # path('role/gm', GetGeneralManagerRole.as_view(), name="gm_role"),
