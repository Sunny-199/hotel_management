...
from accounts.serializers import UserSerializerGet
...
class GuestSerializerGet(serializers.ModelSerializer):
    hotel = HotelSerializer(read_only=True)
...
class GuestSerializerEdit(serializers.ModelSerializer):
