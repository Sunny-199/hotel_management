...
class Hotel(models.Model):
    ...
    general_manager = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, null=True, blank=True, related_name='general_manager')
...
class Room(models.Model):
    resident = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, null=True, blank=True)
    menu_array = ArrayField(models.IntegerField(blank=True, null=True), default=list, size=8,)
