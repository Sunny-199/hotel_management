...
#
#
# def upload_to_s3(file_name, body, content_type='image/jpg'):
#     try:
#         # session = Session(aws_access_key_id=ACCESS_KEY, aws_secret_access_key=SECRET_KEY)
#         # s3 = session.resource('s3')
#         # s3.Bucket(BUCKET_NAME).put_object(Key=file_name, Body=body, ContentType=content_type)
#
#         # session = Session(aws_access_key_id=ACCESS_KEY, aws_secret_access_key=AWS_SECRET_KEY)
#         # # s3 = session.resource('s3')
#         # s3 = session.client("s3")
#         # s3.put_object(Key=file_name, Body=body, Bucket='BUCKET_NAME', ContentType=content_type)
#         s3 = boto3.client('s3', aws_access_key_id=ACCESS_KEY,
#                           aws_secret_access_key=AWS_SECRET_KEY)
#
#         try:
#
#             s3.upload_file(body, BUCKET_NAME, file_name)
...
#         auto_gen_url = s3.generate_presigned_url(
...
#         )
#         url = f"https://{bucket_name}.s3.amazonaws.com/{file_name}"
#         print("Upload Successful:", auto_gen_url, url)
#         return True, url
#     except FileNotFoundError:
#         print("The file was not found")
#         return False
